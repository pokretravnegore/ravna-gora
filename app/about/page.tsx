  ...
  return (
    <div className="min-h-screen bg-offwhite-1 flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* ════════════════ HERO ════════════════ */}
        <div className="max-w-[1512px] mx-auto px-4 md:px-6 xl:px-10 pt-[var(--space-8)]">
        ...
        {/* ════════════════ CONTENT ════════════════ */}
        <div className="max-w-[1512px] mx-auto px-4 md:px-6 xl:px-10 py-[var(--space-10)] flex flex-col gap-[var(--space-10)]">

          {/* ── About the Movement ── */}
          <section className="flex flex-col xl:flex-row items-start gap-[var(--space-10)] xl:gap-[73px]">

            {/* Text column */}
            <div className="flex flex-col gap-[var(--space-text-tp)] w-full xl:w-[490px] shrink-0">
            ...
            {/* Photo column */}
            <div className="flex flex-col gap-[10px] w-full xl:w-[706px] p-[10px]">
              <div className="relative w-full h-[320px] md:h-[480px] xl:h-[765px] overflow-hidden">
                <img
          ...
          <section className="flex flex-col gap-[var(--space-text-tp)] pb-[var(--space-8)]">
